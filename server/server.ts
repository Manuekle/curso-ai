// server/server.ts
// Backend Express local — expone agent, RAG y orquestador al frontend.
// Observabilidad (#49): log estructurado por request.

import "dotenv/config";
import express from "express";
import multer from "multer";
import { runAgent } from "./agent";
import { ask, indexDocument, store, cosine, embed, userCanAccess } from "./rag";
